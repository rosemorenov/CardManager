...
namespace CardManager.Pages.Cards
{
    ...
    {
        // ------------------------------------------------------------
        // Private database context for interacting with the SQLite DB.
        // Dependency Injected via constructor from Program.cs
        // ------------------------------------------------------------
        ...
        {
            // ------------------------------------------------------------
            // Example usage of several required programming concepts:
            // • Variables
            // • Math
            // • Boolean operators
